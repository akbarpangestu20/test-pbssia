     ...
     <table class="w-full">
        ...
        <thead>
            <tr class="bg-yellow-300 h-5">
                ...
                <th class="border-2 border-rose-500 w-2/12">Telepon</th>
        ...
        <tbody class="text-center">
            ...
            <tr>
                ...
                <td class="text-justify border-2 border-rose-500 px-2.5">{{$output->jabatan_karyawan}}</p></td>
            </tr>
            @endforeach
     </table>
